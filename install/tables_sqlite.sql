--
-- This file was generated by ChronosGenerator wcmf-1.0.24.0002 from model.uml 1.0.
...
(
  `id` INT(11) NOT NULL, -- columnId=_generated_
...
(
  `id` INT(11) NOT NULL, -- columnId=_generated_
  `fk_user_id` INT(11), -- columnId=_generated_ referencedTable=User
...
(
  `fk_role_id` INT(11), -- columnId=_generated_ referencedTable=Role
  `fk_user_id` INT(11), -- columnId=_generated_ referencedTable=User
...
(
  ...
  `created` DATETIME, -- columnId=_generated_
  `creator` VARCHAR(255), -- columnId=_generated_
  `modified` DATETIME, -- columnId=_generated_
  `last_editor` VARCHAR(255), -- columnId=_generated_
  PRIMARY KEY (`id`)
);
--
...
(
  `id` INT(11) NOT NULL, -- columnId=_generated_
  `fk_publisher_id` INT(11), -- columnId=_generated_ referencedTable=Publisher
...
(
  `id` INT(11) NOT NULL, -- columnId=_generated_
  `fk_chapter_id` INT(11), -- columnId=_generated_ referencedTable=Chapter
  `fk_book_id` INT(11), -- columnId=_generated_ referencedTable=Book
  `fk_author_id` INT(11), -- columnId=_generated_ referencedTable=Author
...
(
  `id` INT(11) NOT NULL, -- columnId=_generated_
  `fk_chapter_id` INT(11), -- columnId=_generated_ referencedTable=Chapter
  `fk_titlechapter_id` INT(11), -- columnId=_generated_ referencedTable=Chapter
...
(
  `id` INT(11) NOT NULL, -- columnId=_generated_
  `fk_referencedbook_id` INT(11), -- columnId=_generated_ referencedTable=Book
  `fk_referencingbook_id` INT(11), -- columnId=_generated_ referencedTable=Book
