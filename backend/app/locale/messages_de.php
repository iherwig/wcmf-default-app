...
$messages_de['<em>%0%</em> has unsaved changes. Leaving the page will discard these. Do you want to proceed?'] = '<em>%0%</em> hat nicht gespeicherte Änderungen. Wenn Sie die Seite verlassen, gehen diese verloren. Wollen Sie fortfahren?';
// file(s): public/js/ui/data/widget/EntityListWidget.js, public/js/ui/data/widget/EntityRelationWidget.js
$messages_de['<em>%0%</em> was successfully copied'] = '<em>%0%</em> wurde erfolgreich kopiert';
// file(s): public/js/ui/data/widget/EntityFormWidget.js
$messages_de['<em>%0%</em> was successfully created'] = '<em>%0%</em> wurde erfolgreich erstellt';
// file(s): public/js/ui/data/widget/EntityListWidget.js, public/js/ui/data/widget/EntityRelationWidget.js
$messages_de['<em>%0%</em> was successfully deleted'] = '<em>%0%</em> wurde erfolgreich gelöscht';
// file(s): public/js/ui/data/widget/EntityFormWidget.js
$messages_de['<em>%0%</em> was successfully locked'] = '<em>%0%</em> wurde erfolgreich gesperrt';
// file(s): public/js/ui/data/widget/EntityRelationWidget.js
$messages_de['<em>%0%</em> was successfully unlinked'] = '<em>%0%</em> wurde erfolgreich gelöst';
// file(s): public/js/ui/data/widget/EntityFormWidget.js
...
$messages_de['Confirm Import'] = 'Import bestätigen';
...
// file(s): public/js/ui/data/EntityPage.js
$messages_de['Detail view class for type <em>%0%</em> not found.'] = '';
// file(s): public/js/action/Delete.js, public/js/ui/_include/widget/ConfirmDlgWidget.js, public/js/ui/_include/widget/PopupDlgWidget.js
$messages_de['Do you really want to delete <em>%0%</em> ?'] = 'Wollen Sie <em>%0%</em> wirklich löschen?';
// file(s): public/js/ui/data/widget/ImportWidget.js
$messages_de['Do you really want to import <em>%0%</em> ?'] = 'Wollen Sie <em>%0%</em> wirklich importieren?';
...
// file(s): public/js/ui/data/widget/template/EntityListWidget.html
$messages_de['Import CSV'] = 'CSV importieren';
// file(s): application/controller/CSVImportController.php
$messages_de['Importing %0%'] = 'Importiere %0%';
// file(s): public/js/ui/data/widget/ImportWidget.js
$messages_de['Import result'] = 'Importergebnis';
// file(s): application/controller/SearchIndexController.php
$messages_de['Indexing %0% %1% objects, starting from %2%., '] = 'Indexiere %0% %1% Objekte, beginnend bei %2%., ';
...
// file(s): public/js/ui/data/widget/EntityRelationWidget.js
$messages_de['Linking objects'] = 'Verknüpfe Objekte';
...
$messages_de['Loading tree: continue with %0%'] = 'Lade Baum: weiter mit %0%';
...
$messages_de['Permissions for <em>%0%</em>'] = 'Rechte für <em>%0%</em>';
// file(s): public/js/ui/data/widget/template/PermissionDlgWidget.html
...
// file(s): public/js/ui/data/widget/ImportWidget.js
$messages_de['Skipped rows'] = 'Ignorierte Zeilen';
// file(s): src/model/_base/ChapterRDBMapper.php
...
// file(s): lib/security/principal/impl/AbstractUser.php
$messages_de['Super users must be active'] = 'Super User können nicht deaktiviert werden';
// file(s): src/model/wcmf/_base/UserRDBMapper.php
$messages_de['super_user'] = 'Super User';
// file(s): src/model/wcmf/_base/DBSequenceRDBMapper.php
$messages_de['table'] = '';
...
// file(s): public/js/ui/data/widget/ImportWidget.js
$messages_de['The import process finished with the following result'] = 'Der Importvorgang wurde mit folgendem Ergebnis beendet';
// file(s): src/model/wcmf/_base/TranslationRDBMapper.php
...
// file(s): lib/security/principal/impl/AbstractUser.php
$messages_de['The super user property cannot be withdrawn by self'] = 'Die Super User Eigenschaft kann nicht vom eigenen User entfernt werden';
// file(s): lib/security/principal/impl/AbstractUser.php
$messages_de['The super user property can only be changed by super users'] = 'Die Super User Eigenschaft kann nur von Super Usern geändert werden geändert werden';
// file(s): src/model/wcmf/_base/TranslationRDBMapper.php
...
$messages_de['Translate list values to display values'] = 'Listenwerte in Anzeigewerte umwandeln';
// file(s): src/model/wcmf/_base/TranslationRDBMapper.php
...
$messages_de['Your session is lost. Please sign in.'] = 'Die Session ist abgelaufen. Bitte neu anmelden.';
